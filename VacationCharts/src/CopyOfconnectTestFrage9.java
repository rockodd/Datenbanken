...
public class CopyOfconnectTestFrage9 {
	...
	public static void main(String args[]) {
		...
		Connection con;
		String query = "Select Count(*) From VACATIONREQUEST vaq where contains(vaq.QUERYTEXT,'car AND rental',1)>0";
		...
		JFreeChart chart = ChartFactory
				.createPieChart(
						"Für welches Urlaubsziel werden am meisten Mietwagen gesucht?", // Title
						pieDataset, // Dataset
						true,// legend
						true,// tooltips
						true// URL
		...
		ChartFrame frame = new ChartFrame("Anfrage 9", chart);
		frame.pack();
