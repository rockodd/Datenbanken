...
public class CopyOfconnectTestFrage8 {
	...
	public static void main(String args[]) {
		...
		Connection con;
		String query = "Select to_char(reqtime, 'DAY') as stunde, Count(*) From VACATIONREQUEST Group By to_char(reqtime, 'DAY') Order By to_char(reqtime, 'DAY') ASC";
		...
		JFreeChart chart = ChartFactory
				.createPieChart(
						"Welche Transportmittel werden am häufigsten verwendet?", // Title
						pieDataset, // Dataset
						true,// legend
						true,// tooltips
						true// URL
